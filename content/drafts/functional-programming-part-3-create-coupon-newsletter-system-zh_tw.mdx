...
上一篇著重在練習分辨「動作」、「計算」和「資料」，可以參考這一篇 [函式程式設計 Part 2 - 分辨動作、計算和資料](/zh-TW/blog/functional-programming-part-2-identify-action-calculations-data-zh_tw)，
