...
- ref：代表 **Reference Token (參考值)**，定義最基本的設計數值，例如：md.ref.color.blue.50
- sys：代表 **System Token (系統語意 token)**，具備語意化，描述用途，例如：md.sys.text.primary
- comp：代表 **Component Token (元件層級 token)**，專屬某一個元件的樣式，例如：md.comp.primary.background
