...
在從下載資源到渲染頁面的[瀏覽器工作流程第一部分](/zh-TW/blog/browser-workflow-from-downloading-resources-to-rendering-the-page-part-1-zh_tw)，我們回顧了當使用者輸入網址並按下 Enter 鍵後，瀏覽器背後的工作流程。接著在從[下載資源到渲染頁面的瀏覽器工作流程第二部分](/blog/browser-workflow-from-downloading-resources-to-rendering-the-page-part-2-zh_tw)，我們回顧了瀏覽器如何處理請求和回應的詳細過程。
