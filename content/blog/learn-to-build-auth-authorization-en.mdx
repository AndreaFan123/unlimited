...
In the [When the Frontend Starts Thinking About Backend Architecture, Part 1](/en/blog/learn-to-build-auth-en), we talked about how to think about auth system design. When building things, we often run into permission issues in admin systems.
