...
在文章瀏覽器渲染 pipeline 第一部分中，我們已經回顧了[瀏覽器渲染 pipeline part 1](/zh-TW/blog/browser-rendering-pipeline-part-1-zh_tw)，並了解到瀏覽器會解析 HTML 和 CSS 並建立 DOM 樹和 CSSOM 樹，這背後的主要角色是渲染引擎。
