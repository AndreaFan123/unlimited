...
在[瀏覽器渲染 pipeline part 1 ](/zh-TW/blog/browser-rendering-pipeline-part-1-zh_tw)和[瀏覽器渲染 pipeline part 2](/zh-TW/blog/browser-rendering-pipeline-part-2-zh_tw) 這兩篇文章中，我們已經回顧了瀏覽器渲染 pipeline，並了解瀏覽器會解析 HTML、CSS 和 JavaScript 程式碼來渲染頁面，現在讓我們談談 JavaScript 引擎。
